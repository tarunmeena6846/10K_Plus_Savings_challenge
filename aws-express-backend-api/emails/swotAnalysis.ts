export const getSWOTAnalysisTemp = () => {
  return `<!DOCTYPE html>
  <html lang="en">
  <head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Monthly SWOT Analysis Reminder</title>
    <style>
      body {
  ...
  <body>
    <div class="container">
      <div class="content">
        ...
        <p>TO SUPPORT YOUR EFFORTS OF HITTING YOUR SAVINGS GOAL BY END-OF-YEAR, YOU AGREED TO COMPLETE A MONTHLY SWOT ANALYSIS.</p>
